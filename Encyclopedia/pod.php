	...
	if($num>0){
			...
			$need=explode("|",$ITEM['need']);
				...
				switch($treb[0])
				{
					...
					case 74: $tr_b.="&nbsp;Стоимость улучшения: <b>$treb[1]</b><img src=http://image.neverlands.ru/signs/neye.gif><br>";break;
								...
								foreach ($par as $value) {
									...
									if($stat[1]>0){$plus = "+";}else{$plus ="";}
										switch($stat[0]){
											...
											case 74: $tr_s.= "Стоимость улучшения: $plus<b>$stat[1]</b><img src=http://image.neverlands.ru/signs/neye.gif><br>";break;
										}}
				$ResultBody .= $tr_s.'</td>
...
print '<center><img src="images/60176924db95.jpg"></center>
	<LEGEND align=center><B>&nbsp;Подарочное Шмутьё!!!&nbsp;</B></LEGEND>
	<table cellpadding=10 cellspacing=0 border=0 width=100%>
	<tr><td class=freetxt>
	<font class=nickname>
	<a href="?set=16&art=2"><b><font color=#333333>Северного Варвара</font></b></a><br>
	<a href="?set=17&art=1"><b><font color=#333333>Ярла</font></b></a><br>
	<a href="?set=18&art=1"><b><font color=#333333>Конунга</font></b></a><br>
	<a href="?set=19&art=2"><b><font color=#333333>Северного Шамана</font></b></a><br>
	<a href="?set=20&art=1"><b><font color=#333333>Северного Заклинателя</font></b></a><br>
	<a href="?set=21&art=1"><b><font color=#333333>Северного Колдуна</font></b></a>
	</td></tr>
	</table>';
if(!empty($ResultBody))
{
